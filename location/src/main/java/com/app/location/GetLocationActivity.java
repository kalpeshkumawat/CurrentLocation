...
public class GetLocationActivity extends AppCompatActivity {
    ...
    private void iniUtils() {
        ...
        gpsDialog = new Dialog(this, android.R.style.Theme_Black_NoTitleBar_Fullscreen);
        gpsDialog.setContentView(R.layout.dialog_no_gps_on);
        gpsDialog.setCancelable(false);
        gpsDialog.setCanceledOnTouchOutside(false);

        permissionDialog = new Dialog(this, android.R.style.Theme_Black_NoTitleBar_Fullscreen);
    ...
    private boolean checkFineLocationPermission() {
        int result = ContextCompat.checkSelfPermission(GetLocationActivity.this, Manifest.permission.ACCESS_FINE_LOCATION);
    ...
    private void errorToast() {
        ...
        Toast.makeText(this, "Sorry! Something went wrong, Please try later...", Toast.LENGTH_SHORT).show();
    }
